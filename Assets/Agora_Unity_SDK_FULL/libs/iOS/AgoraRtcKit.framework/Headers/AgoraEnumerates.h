...
/** The mode of super resolution.
 ...
 @since v3.7.1
 */
typedef NS_ENUM(NSUInteger, AgoraVideoSRMode) {
...
typedef NS_ENUM(NSUInteger, AgoraConnectionChangedReason) {
  ...
  /** 3: The connection is banned by the server. This occurs when the server calls the [Banning user privileges API](https://docs.agora.io/en/Interactive%20Broadcast/rtc_channel_management_restfulapi?platform=RESTful#banning-user-privileges to kick the user out of the channel. You can display a pop-up box in the application that says: "The user has been banned from this channel." */
  AgoraConnectionChangedBannedByServer = 3,
  /** 4: The SDK fails to join the channel. This occurs when the SDK fails to rejoin the channel within 20 minutes after receiving the [connectionChangedToState(AgoraConnectionStateReconnecting, AgoraConnectionChangedInterrupted)]([AgoraRtcEngineDelegate rtcEngine:connectionChangedToState:reason:]) callback and stops trying. You can display a pop-up box in the application that says: "Failed to join the channel due to network issues. Please try to rejoin the channel after switching to a different network." */
  AgoraConnectionChangedJoinFailed = 4,
  /** 5: The SDK has left the channel. */
  AgoraConnectionChangedLeaveChannel = 5,
  /** 6: The specified App ID is invalid. Check whether the App ID used by the user is the same as [the App ID obtained from the Agora Console](https://docs.agora.io/en/Agora%20Platform/get_appid_token?platform=All%20Platforms#get-the-app-id), and then try to rejoin the channel with a valid App ID. */
  AgoraConnectionChangedInvalidAppId = 6,
  /** 7: The specified channel name is invalid. The channel name cannot be empty nor longer than 64 bytes in length. For supported characters, see the `channelName` parameter in [joinChannelByToken]([AgoraRtcEngineKit joinChannelByToken:channelId:info:uid:joinSuccess:]). You can display a pop-up box in the application that says: "The channel name is invalid. Please try to rejoin the channel with a valid channel name." */
...
typedef NS_ENUM(NSInteger, AgoraLocalVideoStreamError) {
  ...
  /** 11: (macOS only) The shared window is minimized when you call
   ...
   The SDK cannot share a minimized window. You can cancel the minimization of this window at the application layer, such as maximizing this window.
